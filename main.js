...
const clock = () =>{
    ...
    //we add a rotation to the element
    // console.log(hh,mm);
...
const textHour = document.getElementById('text-Hour'),
 ...
 const clockText = () =>{
   ...
   //we change hours from 24 to 12  hours establish 
   let date = new Date()
...
//we detect when its 0am and transform it to 12 am 
if (hh==0) { hh = 12 }

//show a 0 before hours 
if(hh < 10) {hh = `0${hh}`}

//show a 0 before minutes
if(mm < 10) {mm = `0${mm}`}
